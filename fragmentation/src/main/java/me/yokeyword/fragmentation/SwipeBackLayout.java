...
import androidx.core.app.BetterViewDragHelper;
...
import com.basic.homework.fragmentation.R;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    public static final int EDGE_LEFT = BetterViewDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = BetterViewDragHelper.EDGE_RIGHT;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = BetterViewDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = BetterViewDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = BetterViewDragHelper.STATE_SETTLING;
    ...
    private static final String IS_ATTCH_STACK = "isAttchStack";

    private float mScrollFinishThreshold = DEFAULT_SCROLL_THRESHOLD;

    private BetterViewDragHelper mHelper;
    ...
    private void init() {
        mHelper = BetterViewDragHelper.create(this, new ViewDragCallback());
        int colors[] = {0x00000000, 0x06000000, 0x12000000};//分别为开始颜色，中间颜色，结束颜色
        GradientDrawable mDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, colors);
        setShadow(mDrawable, EDGE_LEFT);
     ...
     * Get ViewDragHelper
     */
    public BetterViewDragHelper getViewDragHelper() {
        return mHelper;
    }
     ...
     * The callback's {@link BetterViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link BetterViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (isDrawView && mScrimOpacity > 0 && mHelper.getViewDragState() != BetterViewDragHelper.STATE_IDLE) {
    ...
    private class ViewDragCallback extends BetterViewDragHelper.Callback {
                    ...
                    if (mFragment != null) {
                        ...
                        if (fragmentList != null && fragmentList.size() > 1) {
                            ...
                            for (int i = index - 1; i >= 0; i--) {
                                ...
                                if (fragment != null && fragment.getView() != null && fragment.getArguments().getBoolean(IS_ATTCH_STACK,true)) {
