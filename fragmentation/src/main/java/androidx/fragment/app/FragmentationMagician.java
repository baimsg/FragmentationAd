...
//            return fragmentManager.getFragments();
    ...
    private static void hookStateSaved(FragmentManager fragmentManager, Runnable runnable) {
        ...
        if (isStateSaved(fragmentManager)) {
            boolean tempStateSaved = fragmentManager.isStateSaved();
...
//            fragmentManagerImpl.mStateSaved = tempStateSaved;
     ...
     */
    private static void compatRunAction(FragmentManager fragmentManagerImpl, Runnable runnable) {
//        if (!sSupportGreaterThan27dot1dot0) {
//            runnable.run();
//            return;
//        }
//        boolean tempStopped = fragmentManagerImpl.mStoped;
